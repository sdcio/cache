...
bin/cachectl create -n $cache2 --ephemeral
bin/cachectl create -n $cache3 --cached
bin/cachectl list
...
numpaths=1000
bin/cachectl list | xargs -rn1 bin/cachectl delete -n
echo bench persistent not cached
bin/cachectl bench --create --num-path $numpaths
bin/cachectl list | xargs -rn1 bin/cachectl delete -n
echo bench persistent cached
bin/cachectl bench --create --cached --num-path $numpaths
bin/cachectl list | xargs -rn1 bin/cachectl delete -n
echo bench ephemeral
bin/cachectl bench --create --ephemeral --num-path $numpaths
