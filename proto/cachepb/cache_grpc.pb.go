...
const (
	Cache_List_FullMethodName            = "/cache.proto.Cache/List"
	Cache_Get_FullMethodName             = "/cache.proto.Cache/Get"
	Cache_Create_FullMethodName          = "/cache.proto.Cache/Create"
	Cache_Delete_FullMethodName          = "/cache.proto.Cache/Delete"
	Cache_Exists_FullMethodName          = "/cache.proto.Cache/Exists"
	Cache_CreateCandidate_FullMethodName = "/cache.proto.Cache/CreateCandidate"
	Cache_Clone_FullMethodName           = "/cache.proto.Cache/Clone"
	Cache_Modify_FullMethodName          = "/cache.proto.Cache/Modify"
	Cache_Prune_FullMethodName           = "/cache.proto.Cache/Prune"
	Cache_Read_FullMethodName            = "/cache.proto.Cache/Read"
	Cache_ReadKeys_FullMethodName        = "/cache.proto.Cache/ReadKeys"
...
type CacheClient interface {
	...
	ReadKeys(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (Cache_ReadKeysClient, error)
...
func (c *cacheClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, Cache_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Cache_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) Exists(ctx context.Context, in *ExistsRequest, opts ...grpc.CallOption) (*ExistsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Cache_Exists_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) CreateCandidate(ctx context.Context, in *CreateCandidateRequest, opts ...grpc.CallOption) (*CreateCandidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Cache_CreateCandidate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) Clone(ctx context.Context, in *CloneRequest, opts ...grpc.CallOption) (*CloneResponse, error) {
	...
	err := c.cc.Invoke(ctx, Cache_Clone_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) Modify(ctx context.Context, opts ...grpc.CallOption) (Cache_ModifyClient, error) {
	stream, err := c.cc.NewStream(ctx, &Cache_ServiceDesc.Streams[0], Cache_Modify_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *cacheClient) Prune(ctx context.Context, in *PruneRequest, opts ...grpc.CallOption) (*PruneResponse, error) {
	...
	err := c.cc.Invoke(ctx, Cache_Prune_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) Read(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (Cache_ReadClient, error) {
	stream, err := c.cc.NewStream(ctx, &Cache_ServiceDesc.Streams[1], Cache_Read_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *cacheClient) ReadKeys(ctx context.Context, in *ReadRequest, opts ...grpc.CallOption) (Cache_ReadKeysClient, error) {
	stream, err := c.cc.NewStream(ctx, &Cache_ServiceDesc.Streams[2], Cache_ReadKeys_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &cacheReadKeysClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Cache_ReadKeysClient interface {
	Recv() (*ReadResponse, error)
	grpc.ClientStream
}

type cacheReadKeysClient struct {
	grpc.ClientStream
}

func (x *cacheReadKeysClient) Recv() (*ReadResponse, error) {
	m := new(ReadResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *cacheClient) GetChanges(ctx context.Context, in *GetChangesRequest, opts ...grpc.CallOption) (Cache_GetChangesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Cache_ServiceDesc.Streams[3], Cache_GetChanges_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *cacheClient) Discard(ctx context.Context, in *DiscardRequest, opts ...grpc.CallOption) (*DiscardResponse, error) {
	...
	err := c.cc.Invoke(ctx, Cache_Discard_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) Watch(ctx context.Context, in *WatchRequest, opts ...grpc.CallOption) (Cache_WatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &Cache_ServiceDesc.Streams[4], Cache_Watch_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
type CacheServer interface {
	...
	// ReadKeys reads the index of the store and returns the data
	ReadKeys(*ReadRequest, Cache_ReadKeysServer) error
	// GetChanges made to a candidate
...
func (UnimplementedCacheServer) ReadKeys(*ReadRequest, Cache_ReadKeysServer) error {
	return status.Errorf(codes.Unimplemented, "method ReadKeys not implemented")
}
...
func _Cache_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cache_List_FullMethodName,
	}
...
func _Cache_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cache_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Cache_Exists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cache_Exists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Cache_CreateCandidate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cache_CreateCandidate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Cache_Clone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cache_Clone_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Cache_Prune_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cache_Prune_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Cache_ReadKeys_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ReadRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CacheServer).ReadKeys(m, &cacheReadKeysServer{stream})
}

type Cache_ReadKeysServer interface {
	Send(*ReadResponse) error
	grpc.ServerStream
}

type cacheReadKeysServer struct {
	grpc.ServerStream
}

func (x *cacheReadKeysServer) Send(m *ReadResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Cache_Discard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cache_Discard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Cache_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ReadKeys",
			Handler:       _Cache_ReadKeys_Handler,
			ServerStreams: true,
		},
		{
